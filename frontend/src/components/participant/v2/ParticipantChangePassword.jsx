...
import { changeParticipantPassword } from '../../../services/participant/authService.js';

const ParticipantChangePassword = () => {
            ...
            <form onSubmit={handleSubmit(onSubmit, (err) => console.log('found an error: ', err))} className="space-y-6">
                                ...
                                <div className="flex-1 bg-gray-200 rounded-full h-2">
                                    <div
                                        className={`h-2 rounded-full transition-all duration-300 ${
                                            ...
                                            passwordStrength.strength === 4 ? 'bg-blue-500' : 'bg-blue-600'
                                        }`}
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                        <li className="flex items-center">
                            <div className={`w-2 h-2 rounded-full mr-3 ${newPassword?.length >= 8 ? 'bg-blue-500' : 'bg-gray-300'}`} />
                            At least 8 characters long
                        </li>
                        <li className="flex items-center">
                            <div className={`w-2 h-2 rounded-full mr-3 ${/[a-z]/.test(newPassword) ? 'bg-blue-500' : 'bg-gray-300'}`} />
                        ...
                        <li className="flex items-center">
                            <div className={`w-2 h-2 rounded-full mr-3 ${/\d/.test(newPassword) ? 'bg-blue-500' : 'bg-gray-300'}`} />
                ...
                <div className="flex justify-end space-x-3 pt-4">
                    <button
                        ...
                        className="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        Reset
                    </button>
                    <button
                        type="submit"
                        disabled={isSubmitting || !isDirty}
                        className="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
                    >
                        {isSubmitting ? (
                            <>
...
export default ParticipantChangePassword;