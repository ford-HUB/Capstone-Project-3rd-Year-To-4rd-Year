...
const DonorForgotPasswordModal = ({ isOpen, onClose }) => {
    ...
    // Get store functions
    const { checkEmailForPasswordReset, forgotPassword } = useDonorAuthStore()
        ...
        const checkEmailStatus = async () => {
            ...
            try {
                ...
                if (result.success && result.exists) {
                    // Check if account is from OAuth
                    if (result.isOAuth) {
    ...
    }, [emailValue, checkEmailForPasswordReset])

    const onSubmit = async (data) => {
        // Prevent submission if email is not found, restricted, or OAuth
                             ...
                             <div>
                                 ...
                                 {emailStatus === 'not-found' && (
                                     <p className="text-red-600 text-sm mt-1 flex items-center">
                                         ...
                                         Email not found in our donor system.
                                     </p>
                                 )}
...
export default DonorForgotPasswordModal
