...
const DirectorForgotPasswordModal = ({ isOpen, onClose }) => {
    ...
    // Get store functions
    const { forgotPassword, checkEmailForPasswordReset } = useAuthStore()
    ...
    useEffect(() => {
        const checkEmailStatus = async () => {
            ...
            try {
                // Check if email exists for director accounts using store
                const result = await checkEmailForPasswordReset(emailValue)
    ...
    const onSubmit = async (data) => {
        ...
        setIsLoading(true)
        try {
            // Use the store function for forgot password
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center">
                        <img src={asset.transparentLogo} alt="UCLM CARES" className="h-8 w-8 mr-2" />
...
export default DirectorForgotPasswordModal
