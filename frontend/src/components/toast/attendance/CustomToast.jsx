...
const CustomToast = ({t, userData, message, eventDetails}) => {
    const now = dayjs()
    ...
    return (
        <div
            ...
            <div className={`px-6 py-4 ${isTimeIn ? 'bg-gradient-to-r from-green-50 to-emerald-50' : 'bg-gradient-to-r from-red-50 to-rose-50'} animate-fade-in-up`}>
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className={`text-xl font-bold ${
                            isTimeIn ? 'text-green-800' : 'text-red-800'
                        }`}>
                            {isTimeIn ? 'Checked In' : 'Checked Out'}
                        </span>
                    </div>
                    ...
                    <div className="lg:col-span-1 flex items-center justify-center animate-scale-in">
                        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 text-center w-full hover:scale-105 transition-transform duration-200 border border-gray-200">
                            <p className="text-sm font-medium text-gray-600 mb-2">
                                {isTimeIn ? 'Arrival Time' : 'Departure Time'}
                            </p>
