...
import { createDirectorAddressSchema } from '../../forms/DirectorSchema.js';
import { CircleX } from 'lucide-react';

const EditDirectorAddressModal = ({ open, setOpen, mode, currentInfo, onComplete }) => {
    const isEdit = mode === 'edit'

    const { register, reset, handleSubmit, formState: { errors, isSubmitting } } = useForm({
        resolver: zodResolver(createDirectorAddressSchema),
        defaultValues: {
            province: '',
            city: '',
            postal_code: '',
...
export default EditDirectorAddressModal