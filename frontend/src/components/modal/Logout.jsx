...
const Logout = ({ onOpen, onClose, onConfirm }) => {

    if(!onOpen) return null

  return (
    <>
        <div className={` ${onOpen ? `visible bg-black/20`: `invisible`} fixed inset-0 z-[9999] flex justify-center items-center transition-colors`}>
            ...
            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to logout your account?</h3>
