...
const ParticpantHomePage = () => {
    ...
    // Filter matched events based on participant interests so the main
    // list only shows events that align with the user's selected
    // categories (e.g. School/Education vs Donation Drives).
    const filteredMatchedEvents = React.useMemo(() => {
        ...
        return matchedEvents.filter((event) => {
            ...
            return categories.some((cat) => {
                ...
                // Fuzzy contains match to handle slight wording differences
