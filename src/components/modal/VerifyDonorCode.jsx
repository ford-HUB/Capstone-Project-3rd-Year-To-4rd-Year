...
import { useVerification } from '../../hooks/donor/useVerification.js';
...
const VerifyDonorCode = ({ onVerificationComplete }) => {
    ...
    const { otp_expiration, clearExpiresAt, resendCode, verifyCode } = useVerification()
    ...
    const { checkAuth, authenticatedDonor } = useAuthHooks()
...
export default VerifyDonorCode; 